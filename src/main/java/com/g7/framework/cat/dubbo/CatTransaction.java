...
import com.g7.framework.cat.CatConstants;
import com.g7.framework.cat.context.DubheContext;
import com.g7.framework.cat.context.DubheContextFactory;
...
public class CatTransaction implements Filter {
    ...
    public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
        ...
        try {
            ...
            DubheContext dubheContext = DubheContextFactory.getDubheContext(DubheContextFactory.CONTEXT_JSON_TYPE);
    ...
    private void createProviderCross(URL url, Transaction transaction) {
        String consumerAppName = RpcContext.getContext().getAttachment(com.alibaba.dubbo.common.Constants.APPLICATION_KEY);
